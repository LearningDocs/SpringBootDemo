package com.keepgulp.springbootsocketio.socketio;

import com.keepgulp.springbootsocketio.common.date.DateUtils;
...
public class SocketClient {
     ...
     * 连接错误监听
     */
    private Emitter.Listener onConnetError = new Emitter.Listener() {
        @Override
        public void call(Object... objects) {
     ...
     * 连接超时监听
     */
    private Emitter.Listener onConnetTimeout = new Emitter.Listener() {
        @Override
        public void call(Object... objects) {
