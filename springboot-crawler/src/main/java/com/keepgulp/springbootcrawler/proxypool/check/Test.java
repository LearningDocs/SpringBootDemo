package com.keepgulp.springbootcrawler.proxypool.check;
...
public class Test {
    ...
    private final static String GET_IP_URL = "http://piping.mogumiao.com/proxy/api/get_ip_bs?appKey=538cf5439d5d4ad9bf229355aab040c9&count=10&expiryDate=0&format=1&newLine=2";
